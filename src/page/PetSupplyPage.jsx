        ...
        {filteredList.map((item) => (
          ...
          >
            ...
            <div className="p-5 space-y-3">
              ...
              <button className="w-full mt-4 py-2.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all">
                <Link to={`/listing/${item._id}`}>View Details</Link>
              </button>
            </div>
          </div>
        ))}
